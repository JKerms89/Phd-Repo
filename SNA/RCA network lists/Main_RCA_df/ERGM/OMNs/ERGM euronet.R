...
RCA <- df %>% filter(act2adr == 'horizontal Europeanisation'| act2adr ==  'bottom-up vertical Europeanisation' | act2adr == 'top-down vertical Europeanisation' | act2adr == 'supranational Europeanisation')
...
m2 <- ergm(g2 ~ nodematch('par_fam') + nodefactor('par_fam') + # Difference in connections conditional on party family. 
             edges) # edges term
...
# The results show that right wing parties such as TAN have a high probability 
# of making a tie in the euronet.
